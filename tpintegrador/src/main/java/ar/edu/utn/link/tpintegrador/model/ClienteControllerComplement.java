...
public class ClienteControllerComplement {
	...
	public @ResponseBody String registrar(@PathVariable("clienteId") Integer clienteId,
		...
		cliente.setUsuario(usuario);// solo se deberia setear
       // double valor = precioEnDolares(); ACA VA LO DE DOLARES
