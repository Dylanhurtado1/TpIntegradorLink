...
public class UsuarioController {
	...
	public ResponseEntity<?> getById(@PathVariable("idUsuario") int idUsuario,@PathVariable("idProducto") int idProducto) { //hasta aca todo ok
...
/*	@PreAuthorize("hasRole('USER')") // PERMITE POST PRODUCTOS SOLO A LOS ADMINS
	@PostMapping("/comprar/{id}") //comprar segun id del producto
	public ResponseEntity<?> comprar(@RequestBody ProductoDTO productoDto) {
