...
public class RepoClienteMem {
	...
	public RepoClienteMem() {
		super();
		List<Cliente> of = List.of(new Cliente("Dylan", "Hurtado"), new Cliente("Sergio", "Fernandez"),
				new Cliente("Facundo", "Orellana"), new Cliente("Jorge", "Gimenez"), new Cliente("Agustin", "Hidalgo"));
